...
document.querySelector("h1").innerHTML =
    "show the customers who have no address and spent more then 100 on the products they have bought";
...
function toggleClass(domItem, className) {
    if (domItem.target.classList.length) {
        domItem.target.className.includes(className)
            ? (domItem.target.className = "")
...
document
    .getElementById("run-query-button")
